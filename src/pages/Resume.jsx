      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ margin: "4px 0", fontSize: 14, color: "#aaa" }}>
              ✉️ saxhin0708@gmail.com | 📞 +91 9880762623
            </p>
          </div>
        ...
        >
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, lineHeight: 1.8 }}>
            <li>
              <strong>B.E Computer Science</strong> — R.E.C
              , 2025–2029 <br />
              <span style={{ color: "#aaa" }}></span>
            </li>
            <li style={{ marginTop: 8 }}>
              <strong>12th Board — Government PU College,Gadag-582103</strong> (Karnataka
              Board, 2025) <br />
              <span style={{ color: "#aaa" }}>Percentage: 74.83%</span>
            </li>
            <li style={{ marginTop: 8 }}>
              <strong>10th Board — Bright Horizon English Medium High School</strong> (Karnataka Board, 2023)
              <br />
              <span style={{ color: "#aaa" }}>Percentage: 87.20%</span>
            </li>
          </ul>
        </motion.div>
